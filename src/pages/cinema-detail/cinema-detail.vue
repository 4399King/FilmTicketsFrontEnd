  ...
  <div class="cinema-detail">
    ...
    <view v-if="cinemaDetail">
          ...
          <view class="movie-title line-ellipsis">
            ...
            <text class="grade">
              ...
              <text v-else-if="movie.sc !== '0.0'"
                >{{ movie.sc }}<text class="small">分</text></text
              >
          ...
          >
            ...
            <view class="price box">
              <view class="price-box line-ellipsis">
                ...
                <view
                  class="vipPrice"
                  v-if="item.vipPriceName || item.vipPriceNameNew"
                >
                  <text class="icon">{{
      ...
      <view class="tuan-list" v-if="divideDealList.length">
        ...
        <view
          class="tuan-item"
          v-for="item in divideDealList"
          :key="item.title"
        >
          <view
            v-for="i in item.dealList"
            :key="i"
            class="snack-item"
            bindtap="goSnackPage"
            data-info="i"
