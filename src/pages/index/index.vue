<template>
    <view class="page">
        <customNavBar
            style="position: absolute; width: 100vw; z-index: 100"
        ></customNavBar>
        <!-- 首页轮播图  Begin-->
        <swiper
        ...
        <view class="hot-box">
            <scroll-view scroll-x="true" class="hot page-block">
                <view
                    class="signle-poster"
                    v-for="(item, index) in SuperHotList"
                    :key="index"
                ...
                >
                    <view class="poster-wapper">
                        ...
                        <view class="movie-score" v-if="item.sc != 0"
                            >观众评分
                            <label>{{
                                (item.sc - 0) % 1 == 0
                                    ? item.sc + '.0'
        ...
        <view class="page-block super-hot">
            <view class="hot-title-wapper">
                <image
                    src="../../static/super-movieyg/hotmovie.png"
                    class="hot-ico"
                ></image>
        ...
        <view class="page-block super-hot">
            <view class="hot-title-wapper">
                <image
                    src="../../static/ulike/ulikeico.png"
                    class="hot-ico"
                ></image>
                <view class="hot-title"> 猜你喜欢 </view>
                <view @click="ulikeReload">
                    <image
                        src="../../static/ulike/reload.png"
                        class="hot-ico ulike-reload"
                    ></image>
                </view>
            </view>
        </view>
        <view class="page-block guess-u-like">
            <view
                class="signle-like-movie"
                v-for="(Item, index) in UlikeMovieList"
                :key="index"
            >
                <image
                    :src="serverContent + Item.Bannerpic"
                    class="like-movie-png"
                ></image>
                ...
                <view class="movie-oper" :data-index="index" @click="giveup">
                    <image
                        src="../../static/ulike/giveup.png"
                        class="giveup-ico"
                    ></image>
                    <view class="giveup-me"> 点赞 </view>
                    <view
                        :animation="animationDataArr[index]"
                        class="giveup-me animation-opacity"
                    >
                        +1
                    </view>
                </view>
...
<script>
import traillerStars from '@/components/trailler-stars/trailler-stars.vue'
        ...
        expectedMovie() {
            ...
            uni.request({
                ...
                success: ({ data: res }) => {
                    ...
                    this.mostExpectedList = this.formatImgUrl(
                        res.coming || [],
                        true
                    )
